...
class __TwigTemplate_6e857f3931d39f6fc25017b3493214fba2498e9f766c736a514a3ecf0334c721 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  160 => 24,  156 => 22,  146 => 21,  127 => 19,  115 => 14,  111 => 13,  107 => 12,  102 => 11,  92 => 10,  80 => 7,  76 => 6,  71 => 4,  61 => 3,  38 => 1,);
    }
...
{% block javascripts %}
    ...
    <script src=\"{{asset('assets/js/mangas.js')}}\" defer></script>
    <script src=\"{{asset('assets/js/comic.js')}}\" defer></script>
    <script src=\"{{asset('assets/js/bandeD.js')}}\" defer></script> 
{% endblock %}



{% block title %}Valkyrie Book Store{% endblock %}

{% block body %}

<div class=\"banniere\">
    <img src=\"{{asset('assets/image/valkyrie-high-resolution-logo-black-on-transparent-background.png')}}\" alt=\"\" class=\"logoBanniere\">
</div>
...
{% endblock %}", "home/index.html.twig", "C:\\Users\\ssouh\\Desktop\\soutenance\\eric&quantin\\templates\\home\\index.html.twig");
    }
}
